...
class Producto extends CI_Controller {
	...
	public function index()
	{
		...
		$this->datos["productos"] = $this->Producto_model->getProductos(array(
			"inicio" => 0
		));
	...
	public function agregarproducto($venta)
	{
	...
	public function form_categoria($categoria="")
	{
	...
	public function guardacategoria($categoria="")
	{
		$ca = new Producto_model($categoria);
		$dato["exito"]    = 0;
	...
	public function listaproductos($categoria)
	{
	...
	public function guardaproducto($categoria, $producto="")
	{
		...
		if ($pro->guardaproducto($_POST)) {
			...
			$data["registro"] = $pro->producto->categoria;
		} else {
